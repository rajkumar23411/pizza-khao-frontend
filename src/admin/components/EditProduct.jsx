...
const EditProduct = () => {
  ...
  const { isUpdated, message, error } = useSelector((state) => state.products);
  ...
  return (
    <section className="flex">
      ...
      <div className="flex-1 bg-slate-50">
        <PageHeader pagetitle={["Product", "Edit", `${product?.name}`]} />
              ...
              <>
                ...
                >
                  ...
                  <div className="flex gap-4">
                    <FormDiv>
                      <FormLebel>Regular size price</FormLebel>
                      <FormInput
                        type="text"
                        name="regularPrice"
                    ...
                    <FormDiv>
                      <FormLebel>Medium size price</FormLebel>
                      <FormInput
                        type="text"
                        name="mediumPrice"
                    ...
                    <FormDiv>
                      <FormLebel>Large size price</FormLebel>
                      <FormInput
                        type="text"
                        name="largePrice"
                  ...
                  <FormDiv>
                    <FormLebel>Extra Large size price</FormLebel>
                    <FormInput
                      type="text"
                  ...
                  <FormDiv>
                    <div className="flex items-center justify-between">
                      <FormLebel>
                        {toggleAddCategory ? "Add category" : "Categories"}
                      </FormLebel>
                      <div
                    ...
                    {toggleAddCategory && (
                      ...
                      >
                        <option defaultValue className="font-roboto" disabled>
                          Select category*
                        </option>
                ...
                <div className="flex items-start flex-col gap-2">
                  ...
                  <button
                    ...
                    className="h-12 bg-red-600 text-white w-full uppercase tracking-wider rounded-lg cursor-pointer hover:bg-red-700"
                  >
                    Update product
                  </button>
                </div>
