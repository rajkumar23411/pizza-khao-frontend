  ...
  return (
    <section className="flex items-center justify-center py-10 sm:p-10 flex-col gap-6">
      <div className="text-center">
        <h1 className="text-sm tracking-wider uppercase font-light text-red-700">
          Enjoy the delicasy of pizzas
        </h1>
        <p className="text-xl md:text-2xl lg:text-3xl uppercase text-gray-700 font-medium">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <CategoryBox
          title={"Veggie"}
          markup={"Fresh & flavorful - Explore our veggie delicacies!"}
          uniqueClass={"box_2"}
        />
        <CategoryBox
          title={"Piquant"}
