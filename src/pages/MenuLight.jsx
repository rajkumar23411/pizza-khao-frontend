...
const MenuLight = () => {
    ...
    const { loading: cartLoading, error } = useSelector(
        (state) => state.myCart
    );
    ...
    return (
        <>
            ...
            {isSmallScreen ? (
                ...
                <div
                    className={`flex w-full items-center justify-center py-16 gap-10`}
                >
                    {menuLightCategories.map((cat, i) => (
                        ...
                        >
                            ...
                            />
                            <p
                                className={`uppercase font-medium text-xs font-oswald ${
